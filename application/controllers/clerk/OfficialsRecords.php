...
class OfficialsRecords extends CI_Controller{
	function __construct(){
		parent:: __construct();
		$this->load->model('clerk/officialsRecordsModel', 'm');
	}
	...
	function index(){
		...
		//print_r($data);
		$this->load->view('members/officials_records_view',$data);
	...
	public function add(){
		$this->load->view('layout/header');
		$this->load->view('layout/footer');
		$this->load->view('members/add_officials');
	}
	public function submit(){
		...
		redirect(base_url('clerk/OfficialsRecords/index'));
	}
