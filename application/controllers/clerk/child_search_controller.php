...
class Child_search_controller extends CI_Controller{
	...
	parent::__construct();
		...
		$this->load->model('clerk/child_search_model');
	...
	public function index(){
		...
		$this->load->view('children/child_search_view');
	}
	...
	public function search(){
		...
		if($user != ""){
			...
			$result = $this->child_search_model->search($user);
			...
			if($result){
				...
				$this->load->view('children/child_search_view',$data);
				//print_r($result);
			}
			else{
