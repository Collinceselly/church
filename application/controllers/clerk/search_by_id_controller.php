...
class Search_by_id_controller extends CI_Controller{
	...
	parent::__construct();
		...
		$this->load->model('clerk/search_by_id_model');
	...
	public function index(){
		...
		$this->load->view('visitors/search_by_id_view');
	}
	...
	public function search(){
		...
		if($user != ""){
			...
			$result = $this->search_by_id_model->search($user);
			...
			if($result){
				...
				$this->load->view('visitors/search_by_id_view',$data);
				//print_r($result);
			}
			else{
