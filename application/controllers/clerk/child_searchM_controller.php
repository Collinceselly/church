...
class Child_searchM_controller extends CI_Controller{
	...
	parent::__construct();
		...
		$this->load->model('child_searchM_model');
	...
	public function index(){
		...
		$this->load->view('children/child_searchM_view');
	}
	...
	public function search(){
		...
		if($user != ""){
			...
			$result = $this->child_searchM_model->search($user);
			...
			if($result){
				...
				$this->load->view('children/child_searchM_view',$data);
				//print_r($result);
			}
			else{
