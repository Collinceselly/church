...
<?php echo form_input(array('id' => 'occupation', 'name' => 'occupation', 'placeholder' => 'OCCUPATION/PROFESION', 'value' => set_value('occupation'))); ?><br />

<?php echo form_label('CHURCH LEADERSHIP POST :'); ?> <?php echo form_error('post'); ?><br />
<?php echo form_input(array('id' => 'post', 'name' => 'post', 'placeholder' => 'CURRENT CHURCH LAEDERSHIP POST', 'value' => set_value('post'))); ?><br />

<?php echo form_label('PHONE NUMBER :'); ?> <?php echo form_error('mobile'); ?><br />
...
<?php echo form_label('RESIDENTIAL ADDRESS :'); ?> <?php echo form_error('address'); ?><br />
<?php echo form_input(array('id' => 'address', 'name' => 'address', 'placeholder' => 'WHERE YOU STAY', 'value' => set_value('address'))); ?><br />
