	...
	<a href="<?php echo base_url('modules/OfficialsRecords/index'); ?>" class="glyphicon glyphicon-arrow-left">Back</a>
	<a href="<?php echo base_url('clerk/OfficialsRecords/add'); ?>" class="glyphicon glyphicon-plus">Add New</a>
	...
	<table class="table table-striped table-hover table-responsive table-condensed" id="myTable">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo $member->RESPONSIBILITY; ?></td>
				...
				<td>
					<a href="<?php echo base_url('clerk/OfficialsRecords/edit/'.$member->ID); ?>" class="glyphicon glyphicon-edit"></a>
	
					<a href="<?php echo base_url('clerk/OfficialsRecords/delete/'.$member->ID) ?>" class="glyphicon glyphicon-trash" onclick="return confirm('Are you sure you want to delete this record?');"></a>
				</td>
			</tr>
			<?php
		}
