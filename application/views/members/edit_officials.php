<h3>Edit officials Records</h3>
<a href="<?php echo base_url('clerk/OfficialsRecords/index'); ?>" class="btn btn-default">Back</a>
<form action="<?php echo base_url('/clerk/OfficialsRecords/update') ?>" method="post" class="form-horizontal">
	...
	<div class ="form-group">
		<div class="Membership"><label for="Membership" class="class-md-2 text-right">Membership by</label></div>
		<div class="col-md-3">
			<input type="text" value="<?php echo $members->MEMBERSHIP;?>" name="text_membership" class="form-control" required>
			<select class="class-md-2 text-right" id="resp" name="text_membership">
	...
	<div class ="form-group">
		<label for="responsibility" class="class-md-2 text-right">Responsibility</label>
		<div class="col-md-3">
			<input type="text" value="<?php echo $members->RESPONSIBILITY;?>" name="text_resp" class="form-control" required>
			<select class="class-md-2 text-right" id="responsibility" name="text_resp">
				<option>---select from the list below----</option>
