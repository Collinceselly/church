    ...
    <div class="sh-sideleft-menu">
      ...
      <ul class="nav">
        ...
        <!--<li class="nav-item">
          ...
          <ul class="nav-sub">
            <li class="nav-item"><a href="table-basic.html" class="nav-link active">Basic Table</a></li>
    ...
    <div class="sh-mainpanel">
      ...
      <div class="sh-pagebody">
        ...
        <div class="card bd-primary mg-t-20">
          <div class="card-header bg-primary tx-white">Basic Table</div>
        ...
        <div class="card bd-primary mg-t-20">
          <div class="card-header bg-primary tx-white">Striped Rows</div>
          <div class="card-body pd-sm-30">
        ...
        <div class="card bd-primary mg-t-20">
          <div class="card-header bg-primary tx-white">Bordered Table</div>
          <div class="card-body pd-sm-30">
        ...
        <div class="card bd-primary mg-t-20">
          <div class="card-header bg-primary tx-white">Hoverable Rows</div>
          <div class="card-body pd-sm-30">
        ...
        <div class="card bd-primary mg-t-20">
          <div class="card-header bg-primary tx-white">Color Variations for Table Header</div>
          <div class="card-body pd-sm-30">
