    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="register-form" action="http://keenthemes.com/preview/metronic/theme/admin_3/index.html" method="post">
                ...
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9"></label>
                    <input class="form-control placeholder-no-fix" type="text" placeholder="ID number" name="fullname" /> </div>
                <!--<div class="form-group">
        ...
        <div class="copyright"> <?php echo date("Y") ?> © collince omondi. </div>
        <!-- BEGIN CORE PLUGINS -->
...
<div class="log3">PASSWORD:      <input type="password" name="password" required></div>
<div class="sub>"><input type="submit" value="LOGIN" class="btn btn-info"></div>

<br>

<?php if(isset($collince)){
