<?php echo form_open('reports/individual_tithes_report_controller/viewYear'); ?>
<div class="search1"><h3>Search Year</h3>
	<?php
...
<input type="number" name="date" min="2018" max="2020" placeholder="Year" required><br>
