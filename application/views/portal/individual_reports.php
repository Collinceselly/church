...
<?php } ?>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" action="<?php base_url('port/report/getMyContributions')?>" method="post">
	...
	<div class="by_sabath_date">
		...
		<?php echo form_open(base_url('port/report/getMyContributions'), $attributes); ?>
		<div class="form-group">
			<div class="form-group">
	...
	<div class="by_month">
		...
		<div class="form-group">
			...
			<input type="hidden" id="by_month"  name="by_month" value="by_month"/>
		</div>
	...
	<div class="by_year">
		...
		<div class="form-group">
			...
			<input type="hidden" id="by_year"  name="by_year" value="by_year"/>
		</div>
